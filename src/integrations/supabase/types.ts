    ...
    Tables: {
      ...
      family_members: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "family_members_user_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
      ...
      family_messages: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "family_messages_user_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      room_bans: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "room_bans_user_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      room_messages: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "room_messages_user_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      room_roles: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "room_roles_user_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      room_seats: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "room_seats_user_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      rooms: {
        ...
        Relationships: [
          {
            foreignKeyName: "rooms_owner_profile_fk"
            columns: ["owner_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
